  ...
  projects: [
    ...
    },
    {
      ...
      details: [
        ...
        '亮点一：引入 ESLint、Day.js、Lodash 等现代库与工具，能够显著提升代码质量、开发效率与性能，使项目更具前瞻性与可维护性，有效地推动项目的成功实施。',
    ...
    },
    {
      ...
      details: [
        ...
        '亮点二：将复杂数据以图形和图表的形式呈现，帮助员工更快地理解和分析信息，从而快速做出决策，各项业务流程的办理时间缩短30%，显著提升员工工作效率。'
      ],
      boldWords:[
        '各项业务流程的办理时间缩短30%',
        '难点一',
    ...
    },
    {
      ...
      details: [
        ...
        '亮点一：优化页面加载速度和性能，例如对B端页面进行响应式处理，兼容不同设备，提高用户群体的使用便利性，用户好评度提高了40%。',
        '亮点三：封装全局样式，减少样式代码重复，提高开发效率，将开发成本缩减了2人日。',
      ],
      boldWords:[
