export default {
  ...
  skills: {
    ...
    descriptions: [
      ...
      '了解工程化，包含 Webpack、Vite、Rollup、Babel、Git 等',
  ...
  experiences: [
    ...
    // },
      ...
      type: 'company',
      icon: '/damai.png',
      company: '易宝软件科技有限公司（驻场阿里巴巴）',
      position: '前端开发工程师',
      time: '2024 年 05 月 - 至今',
      descriptions: [
        '负责北京环球度假区小程序和中后台项目迭代开发、负责麦座海外前端项目开发',
      ],
    },
    {
      type: 'company',
